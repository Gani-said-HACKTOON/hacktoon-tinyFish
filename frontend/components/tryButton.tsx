...
export default function TryButton({ className = "", href = "/chatbot" }: TryButtonProps) {
  return (
    <Link href={href}>
      <button
        className={`group relative inline-flex items-center justify-center
          px-8 py-3 h-14 rounded-[45px]
          overflow-hidden cursor-pointer bg-black
          hover:bg-[#1a1615d9] duration-250 ease-out ${className}`}
      >
